...
# DVE full session
# Saved on Mon Apr 23 19:12:52 2018
# Designs open: 1
...
gui_wv_zoom_timerange -id ${Wave.1} 0 11163000
gui_list_add_group -id ${Wave.1} -after {New Group} {uut}
gui_list_select -id ${Wave.1} {SingleCycleProcTest_v.uut.currentPC }
...
gui_marker_move -id ${Wave.1} {C1} 11160000
