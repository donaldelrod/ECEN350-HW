...
# DVE full session
# Saved on Mon Apr 23 14:51:22 2018
# Designs open: 1
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 178]
catch { set Hier.1 [gui_share_window -id ${HSPane.1} -type Hier] }
gui_set_window_pref_key -window ${HSPane.1} -key dock_width -value_type integer -value 178
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value -1
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 177} {height 537} {dock_state left} {dock_on_new_line true} {child_hier_colhier 156} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 394} {height 537} {dock_state left} {dock_on_new_line true} {child_data_colvariable 199} {child_data_colvalue 159} {child_data_coltype 99} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1679} {height 314} {dock_state bottom} {dock_on_new_line true}}
...
gui_sg_addsignal -group "$_session_group_3" { SingleCycleProcTest_v.uut.RegFile.RegWr SingleCycleProcTest_v.uut.RegFile.RA SingleCycleProcTest_v.uut.RegFile.RB SingleCycleProcTest_v.uut.RegFile.BusA SingleCycleProcTest_v.uut.RegFile.BusB SingleCycleProcTest_v.uut.RegFile.RW SingleCycleProcTest_v.uut.RegFile.BusW SingleCycleProcTest_v.uut.RegFile.registers SingleCycleProcTest_v.uut.RegFile.Clk }
...
catch {gui_list_select -id ${Hier.1} {SingleCycleProcTest_v.uut.NextPCLogic}}
...
gui_list_show_data -id ${Data.1} {SingleCycleProcTest_v.uut.NextPCLogic}
