...
# DVE full session
# Saved on Mon Apr 23 15:02:55 2018
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{1 75} {1501 918}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 175} {height 432} {dock_state left} {dock_on_new_line true} {child_hier_colhier 156} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 392} {height 432} {dock_state left} {dock_on_new_line true} {child_data_colvariable 199} {child_data_colvalue 159} {child_data_coltype 99} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1500} {height 312} {dock_state bottom} {dock_on_new_line true}}
...
catch {gui_list_select -id ${Hier.1} {SingleCycleProcTest_v.uut}}
...
gui_list_show_data -id ${Data.1} {SingleCycleProcTest_v.uut}
